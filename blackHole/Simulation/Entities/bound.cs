...
/// <summary>
/// Rendering pipeline for skybox - renders inside-out sphere
/// </summary>
public unsafe class SkyboxPipeline : PipelineBuilder
{
    ...
    // Override to disable depth writes and always pass depth test for skybox
    ...
    {
        if (sphere == null)
            throw new Exception("Sphere not set for SkyboxPipeline.");
    ...
    {
        // Create a simple 1x1 dark blue texture (starfield is procedural in shader)
        uint width = 1;
        uint height = 1;
        byte[] pixels = { 0, 0, 5, 255 };
